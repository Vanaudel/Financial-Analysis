...
price = 'G:/My Drive/Stock_Market_Stuff/Stock_Images/price/'
...
for stock in all_tickers:
    ...
    fig = sns.lineplot(data=data, x='Date', y='Close', hue='ticker', legend = False)
    ...
    fig.figure.savefig(price + stock + ".png")
    plt.clf()
    #plt.close('all')